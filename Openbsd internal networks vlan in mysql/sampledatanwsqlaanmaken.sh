...
#Het verplaatsen van rijen van de sendtabel naar de queuetabel zodat er getest kan worden
#num is hierbij het aantal records wat van de send teruggezet wordt naar de queue
